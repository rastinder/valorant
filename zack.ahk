;RunWait, ping google.com, , Hide
;OutputDebug, %ErrorLevel% problems found while chcking ping
...
watch_add = 0
loop {
    Text:="|<back>*154$10.DkS0kU70y7kC0Ek7W"
 ...
 if (ok:=FindText(0,0,1920,1080, 0, 0, Text))
 {
   ...
   X:=ok.1.x, Y:=ok.1.y, Comment:=ok.1.id
    ...
    Text:="|<back>*162$46.UQzkT0s0wnyQttbnnDvtbaTTwzDaTtxznwzQDULzDnxwC1TwzDbyNwwnwyPtbnnDtvbaTUQ1kD0s3Xk7Xz7U8"
 ...
 if (ok:=FindText(0,0,1920,1080, 0, 0, Text))
 {
   ...
   X:=ok.1.x, Y:=ok.1.y, Comment:=ok.1.id
    ...
    Text:="|<back>*177$42.s7DzzzzlXDzzzzbvDzzzzDzD3sT3DzC1kC1DzAQnwwDzAyHw0DzAyMA0bzAyTAzXlAwrYwk3C0kC1wDD3sT3U"
 ...
 if (ok:=FindText(0,0,1920,1080, 0, 0, Text))
 {
   ...
   X:=ok.1.x, Y:=ok.1.y, Comment:=ok.1.id
    ...
    Text:="|<back>*215$12.DwbtnntbwDwTwDtbnnbtDwU"
...
Text:="|<back>*111$13.DDXXssyCDXXsswwQwQwQwQwSyTU"
...
Text:="|<back>0x1E1E1E@1.00$17.znzz7zwDzkzz3zwDzkzz3zw000008TzsTzsTzsDzsTzsTzszk"
 ...
 if (ok:=FindText(0,0,1920,1080, 0, 0, Text))
 {
   ...
   X:=ok.1.x, Y:=ok.1.y, Comment:=ok.1.id
    ...
    Text:="|<clode>0x000000@1.00$9.U+28Us70s8W2UA"
 ...
 if (ok:=FindText(0,0,1920,1080, 0, 0, Text))
 {
   ...
   X:=ok.1.x, Y:=ok.1.y, Comment:=ok.1.id
    ...
    Text:="|<clode>*171$35.060000yA00032M00044lsS781aN4FE38G1WU6kXXz1BV1Y32N2Fg3AnAmAXVVUsCE"
 ...
 if (ok:=FindText(0,0,1920,1080, 0, 0, Text))
 {
   ...
   Click, %X%, %Y%
    ...
    Text:="|<skipv>*174$16.zziTwMzXlwTXXz4Ty3zwTzUzwFzXXwT7XyCTwTzvzzy"
...
Text:="|<skipv>*161$11.03U7kDkQkstn3w7UC0M"
...
Text:="|<close>*127$14.Dz9zbDnttzAzsTyDzVznDttwzCTtDz8"
...
Text:="|<continue>*192$7.kQD3kwD3XXXXVUU"
...
Text:="|<watchv>*195$42.zzzzzyTDCTyzyTaCTwzyTaCQsDSHa4k8A61aYnAtmQkYzAtmQkokAtyQklnAtyQllnAtmQtlkCA6QttsaCCQU"
 ...
 Text:="|<remaining>*161$54.000010A00clNUV+088ttinNTBwTnB4G9NhaXXx4FtNhaXW14G9NhaXX14GNNhanVt4HtNhaT00000000200000000q00000000AU"
...
Text:="|<crossplay>*89$14.Dz1zWDllsyATkDy7zVzkDslwSCDl7y/zq"
 ...
 Text:="|<conifrm>*211$59.zzzzzkTzzzkTzzzUzzzz4TzzyTzzzwyTzzwTzzztwsC0kFVU03zbAMnX7AA7zCNtb6SQsDwyHnCAwtmTtwbaQNtnYyFnDAsnnb8snaSNlbbCM3kQwnXDCQwTlttriSQx"
 ...
 Text:="|<cros up>*149$9.sTbTty7VyTzbsQ"
...
if errorlevel
{
    Click, 1 , 700
    Sleep 2500
    ImageSearch,xx,yy,0,0,1920,1080,blackscreen.png * 20
    while !errorlevel
    {
        logging(A_IPAddress3 " , black screen",4)
        sleep 10000
        ImageSearch,xx,yy,0,0,1920,1080,blackscreen.png
    }
...
logging(addresses " is up zack1","5")

global last_msg,old_X,old_y
    ...
    ,esc:="|<esc>*122$34.7zzzzWDzzzwQTzzzXszzzwTzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzy7zzzzsTzzzzVzzs"
    ...
    ,dm_selected:="|<dm_selected>0x30FFC1@0.70$22.0003zMNVVVa666QMMNlVVb67yQMMNVVVa666MMMNVVVa0002"
    ,play_black2:="|<play_red>0xFCFFFF@0.86$12.TUTUTUTUTUTUTUTUTUTUTUTUTUTUTUTyTyTyTyTyU"
    ,play_black:="|<play_white>0x888A8A@0.96$30.y00z0y00z0y00z0y00z0y00zwy00zwy00zwy00zwy00zw00000000000000000000U"
    ,main_menu_play:="|<play_red_menu>0xFF4554@0.94$25.Tzk0Dzs07zw03zy01zz00zzU0Tzk0Dzs07zw03zy01zz00zzzzTzzzjzzzrzzzvzzzxzzzyzzzzTzzzjzzzrzzzvzzzxzzzyzzzzTzzzk"
    ,deathmatch_button:="|<death_match_button>*113$17.09tnnnbbbDDCSSQw0tttnnnbbbDDCSSE"
    ,player_a:="|<>*149$8.sDnwU8000kD7U"
    ,player_b:="|<player_b>0xF9F7DB@0.87$47.00000002000000080000000U00Dzzzy0030000000E0000002000000080000000U0000002000000080000000U0000002000000080000000U000000200000008000000002000000080000000U0000002000000080000000U00000020000000U"
    ...
    ,start:="|<start>0xEAEADF@0.90$14.007ztzyTzbztzy3w0z0Dk3w0z0Dk3w0z0Dk3w0z0Dk3w0z0DkU"
    ,start_black:="|<start_black>0x101B24@0.86$16.Dzkzz3zwDzkzz0TU1y07s0TU1y07s0TU1y07s0TU1y07s8"
    ...
    ;,skip_arrow:="|<skip_arrow>*93$15.zkzwDz3zkzwDz3zkzwDt3y0TkVzC7zsTzVzy7zsTzVzy7U"
    ,lvl20:="|<lvl20>*136$38.zUzzkTzkDzw3zszzzwTwTzzzXyDzzzwT7zzzzXXzzzzwFzzzzzUzzzzzwTzXlzzbzmNDzszzqvzw7ztizy1zyvjzUzzCvzwTzbizzbzntDzszw77zw7zzzzy8zzzzz77zzzzXszzzzlz7zzzszszzzwTz0zzkDs"
    ,start_20:="|<start_20>*119$12.Xl9YtgtgngrgbgDY1lU"
    ...
    ,in_queue:="|<in_queue>0xEEE9E3@0.90$25.s77zw3Xzy1lzz0ss3UQQ1kCC0s770Q3Xzi1lzr0szvUQQ1kCC0sC70S73U7z1ztz0zy"
    ,XP900:="|<XP900>0x22FFC7@0.89$46.S07U7U1ts0S0S07bU1s1s0SS07U7U1ts0S0S07bU1s1s0SS07U7U1ts0S0S07bU1s1s0SS07U7U1ts0S0S07bU1s1s0SS07U7U1u"
    ...
    ,match_end:="|<match_end>*116$71."
    ,error_match_making:="|<error_match_making>0xFFFDFF@0.84$27.zz607zsk0s060600k0k060600k0k060600k0zw607zUk0k060600k0k060600k0k060600k0s0707zszzTz7zw"
    ,scoreboard:="|<scoreboard>*107$16.U86Tb9ySbtuTb861btmTbdySbtm0UM"
    ,back:="|<back>*128$22.zsTnz3yTsTnz3yTsTnz3yTsTnz3yTsTnz3yTwDtzsTnzkzbzVzDz3yTy7wzwDtzsTnzkzbzVz8"
    ,crash:="|<crash>*173$13.l0MUCFpdaIXCFXAkXc"
    ,reward:="|<reward>*109$71.zzzzzzzzzzzy3zzzzzzzzzzs7zzzzzzzzzzUDzzzzzzzzzy0Tzzzzzzzzzs0zzzzzzzzzzU1zzzzzzzzzy00000000000007zzzzzzzzzw0Dzzzzzzzzzw0Tzzzzzzzzzw0zzzzzzzzzzw1zzzzzzzzzzxzzzzzzzzzzzy"
    ,dm_not_selected:="|<dm_not_selected>0x003C59@0.71$20.zzzzzzw0batttiSSPbbatttiS0PbbatttiSSPbbatttjzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzs"
...
;fclick(play_black)
logging(1)
logging(A_IPAddress3 " , running",4)

Loop{
    ok = 0
    if !fclick(play_black,"0") and !fclick(play_black2,"0") and !fclick(in_queue,"0") and !fclick(main_menu_play) and !fclick(player_b,"0") and !fclick(scoreboard,"0") ; player icon di jga match wich jdo hunda othon icon chak k player_b naal replace krdo ede naal desktop te poblem andi
        ok:= openval()
    if ( ok != 22)
    {
        if !selectdm()
...
openval(acc_num = 0) ;check if valo is open
{
    ...
    login_page:="|<login_screen>*167$12.00zyzyzy3U3U3U3U3U3U3U3U3U3U3U00U"
        ...
        ,play_button:="|<play_button>*130$18.zzznzzUzzUDzU3zU1zU0TU07U03U01U01U03U07U0TU1zU3zUDzUzznzzzzzU"
...
,alt_tab:="|<alt_tab>0xFCECDE@0.77$10.U71y7stk3U72"

    while !(ping_check())
        Sleep 1000
    kill_epic()
    sleep 5000
    if fclick(crash) ;ifWinExist, Crash
    {
        ...
        if timer =20
        {
            ...
            else
            {
                ...
                if fclick(alt_tab,"0")
                {
                    ...
                    sleep 10
                    send_input("key","tab" ,"down")
                    sleep 10
                    send_input("key","tab" ,"up")
                    sleep 20
    ...
    while (pid.MaxIndex() != 1 )
    {
        ...
        if fclick( play_button,"0") ; need updated pic
        {
    ...
    ;logging(msg,"2")
    ;Sleep 10000 ; disabling because it may interfier in 4k to fullhd detection
}
selectdm()
{
    ...
    resolution_4k:="|<reso_4k>0xEBEEB2@0.90$13.zzzzzzz03U1k0s0Q0C07zvzxzys0Q0C0703U1k0s0Tzzzzzy"
    resolution_4k2:="|<error_4k>0xFEFFFF@0.97$12.tzvzy2w0s0s0s0s0s0s0s0s0s0s0s0s0s0s0s0s0s0Uasd"
    q4k_warning:="|<4k_warning>*125$12.0100Dkzszszsy0U0007sDsTsTsDk0000UMU"
    point_4k:="|<point_4k>*220$13.00DzbznztzwzyTzDzbznztzwzy00E"
    w4k_warning:="|<4k_warning>*110$38.zzzzzzzzzzzzz000003k00000w00000D000003k00000w00000D000003k00000zzw0Dzzzz03zzzzk0zzzzw0Dzzzz03zzzzk0zzzzw0Dzzzz03zzzzk0zzs"
    i_understand_green:="|<i_understand_green>0xFFFFFF@0.93$10.EB0o2E90Y2E90Y2E90Y2E90g2k/0g3kC"
    point_4k:="|<point_4k>*220$13.00DzbznztzwzyTzDzbznztzwzy00E"
    ...
    fclick(play_black2,"1")
    StartTime := A_TickCount
    ElapsedTime := A_TickCount - StartTime
    fix_resolution()
    while (!ok:=FindText(900, 0, 1300, 200, 0, 0, dm_selected))
    {
        if ! fclick(not_right_now)
            fclick(esc_close)

        if fclick(error_7,"1") or fclick(quit,"0") ; fclick(error_code,"1")
        {
            if fclick(error_7,"1")
            {
                logging("freez_7","4")
        ...
        fclick(i_understand_green)
        if (fclick(play_black,"0") or fclick(main_menu_play))
        {
            logging("play red found","2")
            ;fclick(play_black)
            ;Sleep 1000
        ...
        if (ElapsedTime > 190000) ; 3 min to baad v j play na disea
        {
        ...
        if fclick(player_b,"0") ; too much false +ve
        {
        ...
        if (ok:=FindText(0, 0, 1920, 1080, 0, 0, point_4k))
        {
            logging("4k dot found","2")
            if ok.maxindex() = 2
            {
                X:=ok[1].y, Y:=ok[2].y
                diff := y - x
                logging(diff " diff recorded","2")
                if diff = 607
                {
                    fix_resolution()
                    return 1
...
restart()
{
    shtdn_win:="|<shutdown_window>0x0177C7@0.96$71."

    while flick (shtdn_win,"0")
    {
        send_input("key","alt" ,"down")
        send_input("key","f4" ,"down")
        sleep 1
        send_input("key","f4" ,"up")
        send_input("key","alt" ,"up")
        sleep 500
    }
    send_input("key","enter" ,"down")
    send_input("key","enter" ,"up")
    send_input("key","down_arrow" ,"down")
    send_input("key","down_arrow" ,"up")
    send_input("key","enter" ,"down")
    send_input("key","enter" ,"up")
...
fix_resolution()
{
    ...
    send_input("key","alt" ,"up")
    sleep 1000
    val_sv = G:\My Drive\file share\val
    ll = C:\Users\%A_UserName%\AppData\Local\VALORANT\Saved\Config
    loop, %ll%\*,1
    {
        OutputDebug %A_LoopFileName% `n
        FileCopyDir,%val_sv%\extra\Windows , C:\Users\%A_UserName%\AppData\Local\VALORANT\Saved\Config\%A_LoopFileName%\Windows , 1
    }
}
...
CountUnique(arr) {
    ...
    for i, element in arr {
        if (uniqueElements.HasKey(element)) {
...
seacrh_greenbox()
{
    Text:="|<corner>0xF4FFF4@0.82$14.Tzbztk0M0601U0M0601zsTy701U0M0601U0M0701zyTzc"
    fclick(text)
    return
    dot := "|<corner>0xF0F3FF@0.82$8.000061U0002"

    ; Use FindText() to search for the dot string in the searchArea
    searchResults := FindText(0, 0, 1920, 1080, 0, 0, dot)

    ;If we found more than 4 dots
    if (searchResults.maxindex() >= 4) {
        ; Create an array to store the dot positions
        dotPositions := []

        ; Iterate through each search result
        for i, result in searchResults {
            ; Append the dot position to the dotPositions array
            dotPositions.Push({X: result.X, Y: result.Y})
        }

        found := 0
        ; Iterate through all possible combinations of 4 dots
        for i, dot1 in dotPositions {
            for j, dot2 in dotPositions {
                if(i != j) {
                    for k, dot3 in dotPositions {
                        if(i != k && j != k) {
                            for l, dot4 in dotPositions {
                                if(i != l && j != l && k != l) {
                                    xValues := []
                                    yValues := []
                                    xValues.Push(dot1.X, dot2.X, dot3.X, dot4.X)
                                    yValues.Push(dot1.Y, dot2.Y, dot3.Y, dot4.Y)
                                    xCounts := CountUnique(xValues)
                                    yCounts := CountUnique(yValues)
                                    if xCounts.maxindex() >= 2 and yCounts.maxindex() >= 2 {
                                        x := (xCounts[0].Key + xCounts[1].Key) / 2
                                        y := (yCounts[0].Key + yCounts[1].Key) / 2
    ...
    top_left:="|<top_left>0x578485@0.93$9.0003sTA1UA1UU"
        ,bottom_left:="|<bottom_left>0x54888D@0.93$7.A630QC00E"
        ,top_right:="|<top_right>0x578586@0.93$8.003kw0kA30m"
        ,bottom_right:="|<bottom_right>0x54888F@0.93$8.30kA3D3k002"

    top_left_result := FindText(0, 0, 1900, 1080, 0, 0, top_left)
        ,bottom_left_result := FindText(0, 0, 1900, 1080, 0, 0, bottom_left)
        ,top_right_result := FindText(0, 0, 1900, 1080, 0, 0, top_right)
        ,bottom_right_result := FindText(0, 0, 1900, 1080, 0, 0, bottom_right)

    if top_left_result and bottom_left_result and top_right_result and bottom_right_result
    {
        center_x := (top_right_result[1].x - top_left_result[1].x) / 2 + top_left_result[1].x
            ,center_y := (bottom_left_result[1].y - top_left_result[1].y) / 2 + top_left_result[1].y
        logging( "box found " center_x "," center_y,"2")
        clickl(center_x,center_y)
    }
}

change_enemy_color()
{
    settings_icon:="|<settings>0xEEECEA@0.74$10.00A1sDlzbyDkS0k02"
    settings_word:="|<settings_word>0xFFFFFF@0.95$46.zwTzXzw7zlzyDzkM00A01U1U00k060600300M0M00A01U1U00k060600300M0Ty0A01U1zs0k060600300M0M00A01U1U00k060600300M0M00A01U1U00k060600300M0Tz0A01U1zw0k0606"
    purple:="|<purple>*115$24.zznzzznzzznz11nVD4nADCnQDCn0DCnTDCnTD4nAD1tVzDzzzDzzzDzzU"
    red:="|<red>*127$23.0zzwQzzsxzzlvVs3aNa0RnQAs6sNrxkvjvVnAn3r3kE"
    purple_select:="|<purple_select>0xD3D8A0@0.95$1.zzzzk"
    ;*113$15.0E0200E7WCqHQGTWHyGEqHTXCU0400U"
    close_settings:="|<close_settings>0xF0FFFE@0.93$10.zzzkk30A0k30A0k30A0k30A0k30A0k32"

    if fclick(settings_icon)
    {
        sleep 100
        if fclick(settings_word)
        {
            send_input("mm","20","20")
            sleep 1000
            if !fclick(purple,"0")
            {
                ...
                Sleep 30
                send_input("mr","0","0")
                ;fclick(purple_select)
            }
            fclick(close_settings)
            fclick(close_settings)
            send_input("mm","-50","-100")
            return
        }
    }
    logging("clr selection failed", "4")
}
main()
{
    ...
    if (fclick(play_again,"0") or fclick(start,"0") or fclick(scoreboard,"0") )
    {
        if fclick(scoreboard,"0")
        {
            match_time()
            ...
            if waitfor(XP900,"5")
            {
                OutputDebug xp found
                sleep 1000 ; prevent false +ve
                ;change_acc = 1
                if chklvl()
                {
                    kill_epic()
            ...
            if (change_acc != 1)
            {
                if fclick(play_black2)
                {
                    sleep 1000
                    fclick(dm_not_selected)
                    fclick(start)
                    return
                }
        ...
        {
            fclick(dm_not_selected)
            if fclick(start) ;or fclick(start_black)
            {
                change_acc :=chklvl()
                ;sleep 5000
            }
    ...
    ;else
    ;pid := pidListFromName("VALORANT.exe")
    if ((fclick(party_not_ready,"0") or (change_acc = 1) or fclick(quit) or fclick(mm_error,"0")) and !(fclick(skip)) ) ;or fclick(error_code))
    {
...
buy_weapon(gun)
{
    buy_menu:="|<buy_menu>0xE8EAA1@0.71$10.Tvzy7kD0w3kDVzzzwzUS1kD0s7UQ3kU"
    send_input("mc","0","0")
    StartTime := A_TickCount
        ,ElapsedTime := A_TickCount - StartTime
    while !fclick(buy_menu,"0")
    {
...
{
    if x = 1
        IniWrite,start,settings.ini,logs,Clipboards
    else
        IniWrite,stop,settings.ini,logs,Clipboards
    OutputDebug `n aim = %x%
    Sleep 500
    return x
}
chklvl_temp(start = 0)
{
    ...
    if (fclick(lvl20,"0") or fclick(start_20,"0"))
    {
        ...
        else
        {
            ...
            msg = account done
            logging(msg,"4")
            RunWait,copyusersfrommasterfile_tickcount.ahk
            return
        }
    }
    if !(userpath =="ERROR")
    ...
    if instr(num,"fetch")
    {
        if (userpath =="ERROR")
        {
            ...
            else
            {
                ...
                FileReadLine, login_details,%A_WorkingDir%/username.txt, 1
                return login_details
            }
        }
        else
...
send_input(device = "mm",x = 0 ,y = 0)
{
    ...
    try
    {
        Clipboard1 = %device%,%x%,%y%
        IniWrite,%Clipboard1%,settings.ini,logs,Clipboards
        ;IniWrite,%Clipboard1%,c:\Users\%A_Username%\Documents\jatt\settings.ini,logs,Clipboards
        Sleep 80
    }
}
walkbot()
...
fclick(x,clk = 1, mm = 0) ; click with less accuracy
{
...
gclick(x,clk = 1, mm = 0) ; click with full accuracy
{
    if (ok:=FindText(0, 0, 1920, 1080, 0, 0, x))
    {
        X:=ok.1.x, Y:=ok.1.y, Comment:=ok.1.id
...
cursorposi(p1,p2)
{
    Text4:="|<hand3>0xFFFFFF@0.97$13.P0Bg6qnPNhgzyTzDzbzrzvztzwTy7y8"
        ,Text3:="|<mousehand>0xFEFEFE@0.97$20.llVAQMn76CllXgQMv76CllXjzzvzzyzzz"
        ,Text:="|<mousehand>0xFEFFFF@0.97$10.M1h6qPNhaqTxzs"
        ,mouse:="|<mouse>0xFFFFFF@0.97$9.TvzRX4EY"
        ,hand2:="|<hand2>*137$13.YYmGM0A06030100U0E0806"
    Random, r,-1,1
    fix = 0
    i = 1
    loop{
        if (ok:=FindText(0, 0, 1920, 1080, 0, 0, Text)) or (ok:=FindText(0, 0, 1920, 1080, 0, 0, Text3)) or (ok:=FindText(0, 0, 1920, 1080, 0, 0, Text4)) or (ok:=FindText(0, 0, 1920, 1080, 0, 0, hand2))
        {
...
Clickl(p1,p2,pp1 = 6,pp2=6,skipmm = 0)
{
    ;OutputDebug, accuracy %pp1%,%pp2%
...
runval()
{
    ...
    send_input("key","enter")
    return
    Text:="|<valorant_icon>*63$22.DzzkTzy0zzs3zz07zs0Dz00Ts01zU83w1U7U70A0y0zzw0zzs3zzU7zz0Dzy0Ts"
    if !fclick(text,"0")
        OutputDebug valonot found
    ;fclick(text)
    ;fclick(text)
    return
    send_input("key","enter")
...
p::gopreactice()
b::buy_weapon("ak47")
space::send_input("mc","0", "0")
+w::send_input("mm","0", "-50")
+a::send_input("mm","-50", "0")
+s::send_input("mm","0", "50")
+d::send_input("mm","50", "0")
w::send_input("mm","0", "-200")
a::send_input("mm","-200", "0")
s::send_input("mm","0", "200")
d::send_input("mm","200", "0")
q::aimbot("1")
e::aimbot("0 ")
^w::press("w")
^a::press("a")
...
press(key,delay = 500)
{
    send_input("key",key ,"down")
    send_input("key","space" ,"down")
    sleep %delay%
    send_input("key","space" ,"up")
    send_input("key",key ,"up")
}
gopreactice()
{
    fclick(main_menu_play)
    Text:="|<pratice>*175$24.zyTzzyTzzyTzzaNzy6MTw6MDwSSDsyT7szz7zzzzzzzz0Dw00Dw0zzzzzzzzszz7syT7wSSDw6MDy6MTzaNzzyTzzyTzzyTzU"
    fclick(Text)
    Text:="|<enter_range>0xF6FFFE@0.88$13.s1w0z0TUDs7g3n1tkwMS6D37UnkRs6w1y0z0DU7k1k"
    fclick(Text)
    Text:="|<play>0xF8FFFF@0.96$10.02080U2080U2080U2080U2080U2080zzzs"
